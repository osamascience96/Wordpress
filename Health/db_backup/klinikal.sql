...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2022 at 08:16 AM
...
CREATE TABLE `kk_appointment_notes` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `kk_blog_to_category` (
...
CREATE TABLE `kk_email_template` (
  `id` int(11) NOT NULL,
...
(1, 'media-18169037285e0f1b885e008.jpg', 'jpg', 1, 1, '2020-01-03 05:46:32'),
(2, 'media-967969335e0f1b885f332.jpg', 'jpg', 1, 1, '2020-01-03 05:46:32'),
(3, 'media-15402065955e0f1b886d344.jpg', 'jpg', 1, 1, '2020-01-03 05:46:32'),
(4, 'media-1269114305e0f1b889aa4f.jpg', 'jpg', 1, 1, '2020-01-03 05:46:32'),
(5, 'media-19047557375e0f1b889bb14.jpg', 'jpg', 1, 1, '2020-01-03 05:46:32'),
(6, 'media-10420804785e0f1b889efff.jpg', 'jpg', 1, 1, '2020-01-03 05:46:32'),
(7, 'media-14986370945e0f1b88a0011.jpg', 'jpg', 1, 1, '2020-01-03 05:46:32'),
(8, 'media-15245782795e0f1b88a8462.jpg', 'jpg', 1, 1, '2020-01-03 05:46:32'),
(9, 'media-17964721045e0f1b88ad17c.png', 'png', 1, 1, '2020-01-03 05:46:32'),
(10, 'media-15241643955e0f1b88b0157.png', 'png', 1, 1, '2020-01-03 05:46:32'),
(11, 'media-623588825e0f1b88c522b.png', 'png', 1, 1, '2020-01-03 05:46:32'),
(12, 'media-20288955055e0f1b88ca515.png', 'png', 1, 1, '2020-01-03 05:46:32'),
(13, 'media-16583117465e0f1b88d174b.png', 'png', 1, 1, '2020-01-03 05:46:32'),
(14, 'media-5175326295e0f1b88d26f8.png', 'png', 1, 1, '2020-01-03 05:46:32'),
(15, 'media-11427749815e0f1b88ea78d.png', 'png', 1, 1, '2020-01-03 05:46:32'),
(16, 'media-10093157275e0f1b88ec622.png', 'png', 1, 1, '2020-01-03 05:46:32'),
(17, 'media-4496731875e0f3599bbdad.png', 'png', 1, 1, '2020-01-03 07:37:45');
...
CREATE TABLE `kk_medicine_batch` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
CREATE TABLE `kk_medicine_category` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `date_of_joining` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `kk_medicine_purchase` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `kk_patient_doctor` (
  `id` int(11) NOT NULL,
  `patient_id` int(11) NOT NULL,
  `doctor_id` int(11) NOT NULL,
  `appointment_id` int(11) NOT NULL,
...
CREATE TABLE `kk_payment_method` (
  `id` int(5) NOT NULL,
  `name` varchar(100) NOT NULL,
  `description` varchar(255) NOT NULL,
  `other` text NOT NULL,
...
CREATE TABLE `kk_salarytemplate` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `kk_staff_attendance` (
...
(1, 1, 'osamahu96', 'Osama', 'Ahmad', 'osamahu96@gmail.com', '111111111', 'media-5505453175dbaeecba016c.jpg', '{\"address1\":\"Address Line 1\",\"address2\":\"Address Line 2\",\"city\":\"City\",\"country\":\"Country\",\"postal\":\"411048\"}', NULL, NULL, '', NULL, NULL, '$2y$10$b1OIIKzi.jAJnHXu97/A9eVJG5WSdJjTTf8P7/z/BfpDuI5euV0Zq', '', b'1', 1, '2022-01-27 18:30:24');
