<li id="<?php echo $menu_id; ?>">
	<div class="w-accordion" data-id="<?php echo $menu_id ?>" data-type-id="<?php echo $menu_type_id; ?>" data-page-id="<?php echo $menu_page_id; ?>">
		<div class="w-hdr">
			...
			<div class="control"><span>Page</span><i class="ti-angle-down"></i></div>
		</div>
		<div class="w-bdy">
			...
			<div class="form-group">
				<label>Link</label>
				<input type="text" class="form-control form-control-sm" value="<?php echo $menu_label; ?>" readonly>
				<input type="hidden" class="menu-link" value="<?php echo $menu_link; ?>">
