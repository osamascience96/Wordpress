...
<div class="page-title">
    <div class="row align-items-center">
        ...
        <div class="col-sm-6 text-right">
            <a href="<?php echo URL_ADMIN.DIR_ROUTE.'deathrecord/pdf&id='.$result['id']; ?>" class="btn btn-danger btn-sm" target="_blank"><i class="ti-printer pr-2"></i> PDF/Print</a>
            <?php if ($page_edit) { ?>
                <a href="<?php echo URL_ADMIN.DIR_ROUTE.'deathrecord/edit&id='.$result['id']; ?>" class="btn btn-primary btn-sm"><i class="ti-pencil-alt pr-2"></i> Edit</a>
            <?php } ?>
    ...
    $(document).ready(function () {
        ...
        $('.attachment-container').on('click', '.attachment-delete a', function () {
            ...
            $.ajax({
                ...
                data: {name: name, type: 'death', id: '<?php echo $result['id']; ?>', _token: $('.s_token').val()},
                error: function() {
